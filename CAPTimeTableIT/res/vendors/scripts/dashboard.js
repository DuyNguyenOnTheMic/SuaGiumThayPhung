...
var listChartId = ['#chart', '#chart2', '#chart3', '#chart4', '#chart5', '#chart6'];
for (var i = 0; i < listChartId.length; i++) {
	var chartSelector = document.querySelector(listChartId[i]);
	if (chartSelector != null) {
		var chart = new ApexCharts(chartSelector, options);
		chart.render();
    }		
}
